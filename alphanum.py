...
class AlphaNumText:
    ...
    ported from MMP, but changed to take a junction instead (its maybe not
        necessary, but it can be reverted if that's the case)
    
    """
    def __init__(self,drawing,text,size,junc,centered=False):
        self.text=text
        point = junc.coords
